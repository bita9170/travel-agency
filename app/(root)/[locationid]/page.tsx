...
export default function page({ params }: any) {
  ...
  return (
    <MaxLimitWrapper>
      ...
      <div className="grid md:grid-cols-3 gap-4 lg:p-1">
        <Card className="shadow-shadowSmall border-2 rounded-xl lg:col-start-1 lg:col-span-1 flex flex-col">
...
export const RecommendedElement = () => {
  return (
...
export const RecommendedElement2 = () => {
  return (
    <div className="grid md:grid-cols-4 gap-4">
