...
function Page() {
  ...
  useEffect(() => {
    const fetchFavorites = async () => {
      ...
      const favorites = saveLocations.filter(
        (location) => location.type === "favorite"
      );
    ...
    <div className="dashboard-section flex py-10">
      <div className="ml-5 flex flex-col">
        ...
        <ul>
          ...
          <li
            onClick={() => openDialog("myFavorites")}
            className="cursor-pointer flex items-center"
          >
            <MyFavoritesIcon />
        ...
        >
          <DialogContent className="sm:max-w-[80%]">
            <DialogHeader>
              ...
              <DialogDescription>
                Here you can see your favorite places
              </DialogDescription>
            </DialogHeader>
            <div className="grid gap-4 py-4">
              <Layout2
