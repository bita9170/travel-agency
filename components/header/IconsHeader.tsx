...
export function SearchAllIcon({ className }: { className?: string }) {
  return (
...
export function HotelsIcon({ className }: { className?: string }) {
  return (
    <svg className={cn("h-6 w-6", className)} viewBox="0 0 24 24">
      <path d="M0 0h24v24H0V0z" fill="none"></path>
      <path d="M21 10V5H3v5H2v9h2v-2h16v2h2v-9h-1zm-8-3h6v3h-6V7zm-8 3V7h6v3H5zm-1 5v-3h16v3H4z"></path>
    </svg>
  );
}

export function ThingsToDoIcon({ className }: { className?: string }) {
  return (
    <svg className={cn("h-6 w-6", className)} viewBox="0 0 24 24">
...
export function RestaurantsIcon({ className }: { className?: string }) {
  return (
    <svg className={cn("h-6 w-6", className)} viewBox="0 0 24 24">
      <path d="M0 0h24v24H0V0z" fill="none"></path>
